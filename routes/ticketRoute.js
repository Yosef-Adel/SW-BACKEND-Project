...
ticketRouter.get('/:event_id/allTickets',ticketController.getAllTicketsByEventId);
ticketRouter.put('/:event_id/:ticket_id', authorization, ticketController.editTicketById);
ticketRouter.get('/:event_id/availableTickets', ticketController.getAvailableTicketsByEventId);
